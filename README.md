...
## Live Demo
- https://weather-app-one-woad-98.vercel.app/

## Notes
- What we’d improve with more time:
- “Use My Location” button using the Geolocation API to automatically detect the user’s current city and display local weather data.
- Recent searches history using Local Storage, allowing users to quickly reselect previously searched cities.